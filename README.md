...
```markdown
# My interests
i like [machine learning] for [biology]
```

Destine:
```markdown
# Available careers
Studies in [biology], [statistics] 
```
...
| id int | title VARCHAR(255)          | content VARCHAR(255)                |
|--------|-----------------------------|-------------------------------------|
...
| id int | idea_id int | keyword_id int |
|--------|-------------|----------------|
| 1      | 1           | 1              |
| 2      | 1           | 2              |
| 3      | 2           | 2              |
...
| id int | origin_idea_id int | destine_idea_id int | weight int |
|--------|--------------------|---------------------|------------|
| 1      | 1                  | 2                   | 1          |
| 2      | 1                  | 3                   | 2          |
| 3      | 2                  | 1                   | 1          |
